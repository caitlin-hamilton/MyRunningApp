"""
Django settings for my_running_app project.
...
SECRET_KEY = 'xb!yw^+apzi)z(e4o)$9&tx5lj4@jf(+1+eky_x(^9+zfk6mbn'
...
ROOT_URLCONF = 'my_running_app.urls'
...
WSGI_APPLICATION = 'my_running_app.wsgi.application'
